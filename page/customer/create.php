                            ...
                            <form id="form" method="POST" action="">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 gx-3 mb-3">
                                        ...
                                        <input class="form-control <?= $errPhone ? 'is-invalid' : '' ?>" id="phone" name="phone" type="text" placeholder="Telepon" />
                                        <div class="invalid-feedback"><?= $errPhone ?></div>
                                    </div>
                                    <!-- Form Group (email)-->
                                    <div class="col-md-12 gx-3 mb-3">
                                        <label class="small mb-1" for="email">Email</label>
                                        <input class="form-control <?= $errEmail ? 'is-invalid' : '' ?>" id="email" name="email" type="text" placeholder="Email" />
                                        <div class="invalid-feedback"><?= $errEmail ?></div>
                                    </div>
                                    <!-- Form Group (address)-->
                                    <div class="col-md-12 gx-3 mb-3">
                                        <label class="small mb-1" for="address">Alamat</label>
                                        <textarea class="form-control <?= $errAddress ? 'is-invalid' : '' ?>" id="address" name="address" type="text" placeholder="Alamat"></textarea>
